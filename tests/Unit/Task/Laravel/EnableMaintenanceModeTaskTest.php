...
use TYPO3\Surf\Task\Laravel\EnableMaintenanceModeTask;
use TYPO3\Surf\Tests\Unit\Task\BaseTaskTest;

class EnableMaintenanceModeTaskTest extends BaseTaskTest
{
    /**
     * @var EnableMaintenanceModeTask
     */
    protected $task;

    protected function createTask(): EnableMaintenanceModeTask
    {
        return new EnableMaintenanceModeTask();
    }
    ...
    public function executeWithoutArgumentsExecutesViewCacheWithoutArguments(): void
    {
        ...
        $this->assertCommandExecuted("/php 'artisan' 'down'$/");
    }
}
