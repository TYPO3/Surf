------------------------------------------------
TYPO3\\Surf\\Application\\Neos\\FlowDistribution
------------------------------------------------

.. php:namespace: TYPO3\\Surf\\Application\\Neos

.. php:class:: FlowDistribution
    ...
    .. php:method:: checkIfMandatoryOptionsExist()
    ...
    .. php:method:: defineTasks(Workflow $workflow, Deployment $deployment)
