...
class SetUpExtensionsTask extends AbstractCliTask
{
    ...
    public function execute(Node $node, Application $application, Deployment $deployment, array $options = []): void
    {
        ...
        try {
            ...
            $this->logger->warning('TYPO3 Console script (' . $options['scriptFileName'] . ') was not found! Make sure it is available in your project, you set the "scriptFileName" option correctly or remove this task (' . self::class . ') in your deployment configuration!');
            return;
        }
